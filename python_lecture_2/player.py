...
class Player(Bot):
    ...
    def get_action(self, game_state, round_state, active):
        ...
        if continue_cost > 0:
            ...
            # If the probability of winning is greater than the pot odd, we should call
            # or raise

            if strength >= pot_odds:  # nonnegative EV decision
                if strength > 0.5 and random.random() < strength:
                    # the condition here determines how aggresive we
...
if __name__ == "__main__":
    run_bot(Player(), parse_args())
>>>>>>> 1c6129bda0064d05e69fece185d705abec0be4e4
